/*
Jnauary Long challenge -- 2021 ==> https://www.codechef.com/JAN21C/problems/FAIRELCT
...
int main() {
	...
	while(t--){
             ...
             int N = 0, M = 0;
		     int i , j ;
		     long long int  cnt = 0 , sumA = 0 , sumB = 0;
		     bool flag = false;
             
             cin>>N;
             cin>>M;

             long long int arrA[N] , arrB[M];
          ...
          sort(arrA , arrA + N);
          sort(arrB , arrB + M , greater<long long int>());
